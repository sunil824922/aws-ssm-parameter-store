parameters = [
  ...
  { name = "dev.user.REDIS_HOST", value = "elasticache-dev-elasticache.kqnwgv.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.user.mongo_endpoint", value = "mongodb-dev.devops2023sk.online" },
  { name = "dev.cart.REDIS_HOST", value = "elasticache-dev-elasticache.kqnwgv.ng.0001.use1.cache.amazonaws.com" },
  ...
  { name = "dev.rds.DB_HOST", value = "rds-dev-rds.cluster-cxabyfczvvvl.us-east-1.rds.amazonaws.com" },
...
passwords = [
  ...
  { name = "dev.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cxabyfczvvvl.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
